...
const TopRatedCard = ({img, rating, date, title}) => {
  return (
    <div className='h-64 w-[35vw] p-2 md:p-5 flex flex-col justify-between sm:w-[20vw] min-w-[120px] bg-no-repeat bg-center rounded-xl' style={{backgroundImage: `linear-gradient(to bottom, rgba(255, 255, 255, 0.1), rgba(0, 0, 0, 0.73)),
