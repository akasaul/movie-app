        ...
        <div className='w-[40%] mx-auto p-8 bg-black/90 backdrop-blur'>
            <div className='flex flex-col space-y-5'>
                ...
                <div className='flex flex-col space-y-5'>
                    ...
                    <button className='bg-red p-3 text-[1.3rem] rounded'>Sign In</button>
                </div>
                <div className='flex items-center justify-between'>
                  <p className='text-lightGray'>New Here?</p>
                  <a href="/signup" className='text-lightGray hover:text-white'>Sign up</a>
                </div>
            </div>
        </div>
    </div>
...
{/* <input type="text" placeholder="Name" className="input input-bordered input-error w-full border-black max-w-xs" /> */}
